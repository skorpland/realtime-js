...
<p align="center">
  <a href="https://powerbase.club">
        <picture>
      <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/powerbase/powerbase/master/packages/common/assets/images/powerbase-logo-wordmark--dark.svg">
      <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/powerbase/powerbase/master/packages/common/assets/images/powerbase-logo-wordmark--light.svg">
      <img alt="Powerbase Logo" width="300" src="https://raw.githubusercontent.com/powerbase/powerbase/master/packages/common/assets/images/logo-preview.jpg">
    </picture>
  </a>

  <h1 align="center">Powerbase Realtime Client</h1>
  ...
  <p align="center">
    <a href="https://powerbase.club/docs/guides/realtime">Guides</a>
    ·
    <a href="https://powerbase.club/docs/reference/javascript">Reference Docs</a>
    ·
    <a href="https://powerbase.club">Multiplayer Demo</a>
  </p>
</p>

# Overview

This client enables you to use the following Powerbase Realtime's features:
...
```bash
npm install @skorpland/realtime-js
```

## Creating a Channel

```js
import { RealtimeClient } from '@skorpland/realtime-js'
...
- `REALTIME_URL` is `'ws://localhost:4000/socket'` when developing locally and `'wss://<project_ref>.powerbase.club/realtime/v1'` when connecting to your Powerbase project.
